...
function Header(){
  const styleHeaderEl = "mx-auto lg:px-64 fixed top-0 left-0 right-0 h-16 bg-slate-100 flex items-center justify-between px-4 py-8 shadow-lg"
  ...
  return <header className={styleHeaderEl}>
    ...
    <nav className="order-last md:order-3">
      ...
      <ul className={menuIsOpen || "hidden md:block"} id="menu">
        <li><a href="#">Home</a></li>
